...
from my_library.dataset_readers.semantic_scholar_reader import SemanticScholarDatasetReader
...
class TestSemanticScholarDatasetReader(AllenNlpTestCase):
    ...
    def test_read_from_file(self):
        ...
        instances = ensure_list(reader.read('s2_papers.json'))
        ...
        print([t.text for t in fields['title'].tokens])
